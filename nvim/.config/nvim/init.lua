...
require('lazy').setup({
  ...
  --  The configuration is done below. Search for lspconfig to find it below.
  {
    ...
    -- Ensure mason installs the intelephense LSP
...
-- Disable arrows and backspace, i.e. hard mode
...
vim.keymap.set({ 'n', 'i' }, '<Del>', '<Nop>', { silent = true })
